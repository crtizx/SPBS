...
88888888888887SPBS7888888888888
88888888887SMS1Spammer788888888
8888888888888888888888888888888
8888888888888888888888888888888'''+Style.RESET_ALL+Fore.BLUE+'''

https://github.com/crinny
''')
		print(Style.RESET_ALL)
		parser = argparse.ArgumentParser(prog='spymer', description="Style shit by crti. Скорее всего ты проебал момент и половина сервисом уже не работает :D Онли раша нах8й.",epilog='e-mail - invisiblefck@gmail.com')
		parser.add_argument('phonenum', metavar='phone', help='Телефонный номер жертвы (пример: 79996660204)')
